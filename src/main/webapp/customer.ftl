...
<div id="main" class="container-fluid">
    <div class="row">
           ...
           <!--     <li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="ajax-link" href="ajax/user/profiling.html">Profiling Analysis</a></li>
                        <li><a class="ajax-link" href="ajax/user/messages.html">Feedback</a></li>
                    </ul>
                </li>
            </ul>
        </div>
        ...
        <input type="hidden" id="value" value='${userinfo.powerMeterIDs[0]}' />
    </div>
</div>
</body>
</html>
