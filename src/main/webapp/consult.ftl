    ...
    <!--            <li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="ajax-link" href="ajax/admin/patterndiscovery.html">Pattern Discovery</a></li>
                        <li><a class="ajax-link" href="ajax/admin/feedback.html">Feedback Service</a></li>
                    </ul>
                </li><!--
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle">
