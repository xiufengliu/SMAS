 ...
 *  4.7 2005-07-15 isValid( yyyy-mm-dd), new package, com.mindprod.common17,
 *                 getCopyright
 ...
 * @version 5.8 2014-04-29 add isCelebrating. Give all static final constants pure upper case names.
...
public final class BigDate implements Cloneable, Serializable, Comparable {
    ...
    public static String getCopyright() {
        return "BigDate 5.1 freeware Copyright: (c) 1997-2014 Roedy Green, Canadian Mind Products, " +
